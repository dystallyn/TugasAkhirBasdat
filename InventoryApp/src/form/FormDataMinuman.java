...
public class FormDataMinuman extends JFrame {
    ...
    private void initComponents() {
        ...
        txtCari.setBounds(300, 155, 420, 38);
        add(txtCari);

        cmbKategori = new JComboBox<>(new String[]{
            "Semua Kategori", "Teh", "Jus", "Air Mineral", "Kopi", "Susu"
        });
        cmbKategori.setBounds(740, 155, 190, 38);
        add(cmbKategori);

        JButton btnCari = new JButton("Cari");
        btnCari.setBounds(950, 155, 90, 38);
        add(btnCari);

        JButton btnTambah = new JButton("+ Tambah");
        btnTambah.setBounds(1180, 155, 130, 38);
        ...
        tblMinuman.setRowHeight(40);

        tblMinuman.getColumnModel().getColumn(7).setCellRenderer(new IconRenderer("/assets/edit.png"));
        tblMinuman.getColumnModel().getColumn(8).setCellRenderer(new IconRenderer("/assets/delete.png"));
